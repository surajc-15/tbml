  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-gradient-to-br from-sky-400/20 to-cyan-300/20 blur-[100px]" />
        <div className="absolute -bottom-[20%] right-[10%] w-[50%] h-[50%] rounded-full bg-gradient-to-tr from-cyan-400/20 to-blue-400/20 blur-[100px]" />
      </div>
